...
func (c *crushRuleClient) GetRule(ctx context.Context, in *GetRuleRequest, opts ...grpc.CallOption) (*GetRuleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedCrushRuleServer) GetRule(context.Context, *GetRuleRequest) (*GetRuleResponse, error) {
