...
var file_status_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0x50,
	...
	0x6c, 0x79, 0x73, 0x6f, 0x2f, 0x63, 0x65, 0x70, 0x68, 0x2d, 0x61, 0x70, 0x69, 0x2f, 0x61, 0x70,
...
var file_status_proto_goTypes = []interface{}{
	...
	nil,                           // 10: ceph.CephStatusHealth.ChecksEntry
	nil,                           // 11: ceph.CephStatusMgrMap.ServicesEntry
	nil,                           // 12: ceph.CephStatusServiceMap.ServicesEntry
	nil,                           // 13: ceph.CephStatusService.DaemonsEntry
...
var file_status_proto_depIdxs = []int32{
	...
	14, // 7: ceph.GetCephStatusResponse.progress_events:type_name -> google.protobuf.Struct
	10, // 8: ceph.CephStatusHealth.checks:type_name -> ceph.CephStatusHealth.ChecksEntry
	15, // 9: ceph.CephStatusHealth.mutes:type_name -> google.protobuf.Value
	5,  // 10: ceph.CephStatusPGMap.pgs_by_state:type_name -> ceph.CephStatusPGState
	15, // 11: ceph.CephStatusFSMap.by_rank:type_name -> google.protobuf.Value
	11, // 12: ceph.CephStatusMgrMap.services:type_name -> ceph.CephStatusMgrMap.ServicesEntry
	12, // 13: ceph.CephStatusServiceMap.services:type_name -> ceph.CephStatusServiceMap.ServicesEntry
	13, // 14: ceph.CephStatusService.daemons:type_name -> ceph.CephStatusService.DaemonsEntry
	14, // 15: ceph.CephStatusHealth.ChecksEntry.value:type_name -> google.protobuf.Struct
	9,  // 16: ceph.CephStatusServiceMap.ServicesEntry.value:type_name -> ceph.CephStatusService
	15, // 17: ceph.CephStatusService.DaemonsEntry.value:type_name -> google.protobuf.Value
	16, // 18: ceph.Status.GetCephStatus:input_type -> google.protobuf.Empty
	0,  // 19: ceph.Status.GetCephStatus:output_type -> ceph.GetCephStatusResponse
